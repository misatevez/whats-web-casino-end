...
/**
 * Devuelve la hora formateada "HH:MM" para:
 * - strings "HH:MM:SS" sin fecha, o
 * - strings ISO ej. "2025-02-10T08:14:26.127Z".
 */
...
/**
 * Convierte el timestamp a un número (ms desde 1970)
 * para poder ordenar los chats.
 */
...
export function ChatList({ chats, selectedChatId }: ChatListProps) {
  ...
  // Ordenamos los chats usando el timestamp del último mensaje del usuario si existe,
  // o en su defecto el timestamp del admin.
  ...
  // Al hacer click en un chat, actualizamos lastReadByAdmin para marcar que se ha leído el chat
  // y seleccionamos el chat.
  ...
  return (
    <div className="flex-1 overflow-y-auto relative z-20 bg-[#111b21]">
      {sortedChats.map((chat) => {
        ...
        // Usamos el campo unreadCount directamente para el badge.
        const badgeCount = chat.unreadCount ?? 0;

        // Estilos: Si hay mensajes nuevos, mostramos el nombre y el mensaje en negrita o en blanco.
        ...
        return (
          ...
          >
            <Avatar className="h-12 w-12 mr-3">
              <AvatarImage src={chat.photoURL || chat.avatar || DEFAULT_AVATAR} />
