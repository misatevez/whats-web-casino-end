...
// Messages
export const { fetchChatMessages, sendMessage, updateMessageStatus, addMessageToChat } = messages
...
// Additional functions for /admin and /chat
export const { markMessagesAsRead, getUnreadCount, sendInitialMessage } = messages
